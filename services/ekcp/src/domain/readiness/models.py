"""Readiness assessment models (handbook Chapter 23; mirrors EKRE readiness).

A readiness assessment is a named set of findings; it is ready when no finding is
an ERROR. The ``ready`` flag is a computed field so it serializes with the report.
"""
