...
Binds ``tenant_id``, ``correlation_id``, and ``session_id`` to the current
...
_tenant_id: ContextVar[str | None] = ContextVar("ekcp_tenant_id", default=None)
_correlation_id: ContextVar[str | None] = ContextVar("ekcp_correlation_id", default=None)
_session_id: ContextVar[str | None] = ContextVar("ekcp_session_id", default=None)
...
def set_session_id(session_id: str | None) -> Token[str | None]:
    """Bind ``session_id`` to the current context and return a reset token."""
