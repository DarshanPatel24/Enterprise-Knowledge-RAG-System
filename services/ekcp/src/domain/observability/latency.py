"""Stage latency measurement for the conversation timeline.

Records per-stage durations so every governed request can expose a latency
breakdown and the stage timeline can be compared against configured budgets. The
recorder is deterministic under an injected clock, which keeps tests hermetic.
"""
...
class LatencyBreakdown(BaseModel):
    """Immutable per-stage latency breakdown for a single request."""
