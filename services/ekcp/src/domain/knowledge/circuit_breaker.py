"""Circuit breaker for the EKRE knowledge dependency (handbook 16.3).

Trips open after consecutive failures and probes after a reset timeout, so a
saturated or unavailable EKRE never cascades into EKCP. Mirrors the EKRE
resilience pattern; deterministic under an injected clock.
"""
...
class CircuitBreaker:
    """Trip open after consecutive failures; probe after a reset timeout."""
